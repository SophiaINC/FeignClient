        ...
        if(!shell.excecuteIsCertificateIstalled()){
            ...
            if(Files.notExists(pathFile)){
                try {
                    ...
                    LOGGER.info("Se crea la carpeta");
                    LOGGER.info("Inician la configuracion... " + pathFile.toString());
                    targetFile = pathFile.toFile();
            ...
            if(isCreate){
                LOGGER.info("Iniciando instalacion de certificado: "  + pathFile.toString());
